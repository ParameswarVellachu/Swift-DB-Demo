...
class ModelManager: NSObject {
    ...
    func addStudentData(_ studentInfo: DMNewsInfo) -> Bool {
    ...
    func updateStudentData(_ studentInfo: DMNewsInfo) -> Bool {
        sharedInstance.database!.open()
    ...
    func deleteStudentData(_ studentInfo: DMNewsInfo) -> Bool {
        sharedInstance.database!.open()
    ...
    func getAllStudentData() -> NSMutableArray {
        ...
        if (resultSet != nil) {
            while resultSet.next() {
                let studentInfo : DMNewsInfo = DMNewsInfo()
